...
pub(super) const CRYSTAL_SCROLL_SHAPE_LOTTERY_TICKET: i16 = 12;
...
pub(super) const CRYSTAL_STAT_BAG_WEIGHT: u8 = 16;
pub(super) const CRYSTAL_STAT_HAND_WEIGHT: u8 = 17;
pub(super) const CRYSTAL_STAT_WEAR_WEIGHT: u8 = 18;
...
pub(super) const CRYSTAL_STAT_MAX_AC_RATE_PERCENT: u8 = 40;
pub(super) const CRYSTAL_STAT_MAX_MAC_RATE_PERCENT: u8 = 41;
...
pub(super) const CRYSTAL_STAT_HP_RATE_PERCENT: u8 = 46;
