...
$MonsterCombatSoundNames = @('005-1.wav','005-3.wav')
...
function Test-PackageRelativeFileAllowed {
    ...
    if(@('mir2-assets/original-ui/Sound/005-1.wav','mir2-assets/original-ui/Sound/005-3.wav') -ccontains $RelativePath){return $true}
...
if ($SelfTest) {
    ...
    try {
        ...
        $allowedLayoutVectors += @('mir2-assets/original-ui/Sound/005-1.wav','mir2-assets/original-ui/Sound/005-3.wav'); foreach($rel in $allowedLayoutVectors){if(-not(Test-PackageRelativeFileAllowed -RelativePath $rel -ExeName 'mir2-platform-windows.exe')){throw "strict allowlist rejected valid VIS-04 path: $rel"}}
