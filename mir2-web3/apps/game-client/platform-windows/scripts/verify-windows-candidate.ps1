...
function Get-RequiredCandidateFiles {
    ...
    $required = @($ExeName, 'BUILD-ATTESTATION.json', 'PACKAGE-MANIFEST.json', 'VERSION.json', 'RELEASE-STATEMENT.json', 'RELEASE-STATEMENT.p7s', 'mir2-client.toml', 'README-START.txt', 'CONTROLS.txt', 'KNOWN-ISSUES.md', 'mir2-assets\bevy-entity-atlases\manifest.json', 'mir2-assets\generated\map-atlas\manifest.json', 'mir2-assets\generated\native-map-keyed\manifest.json', 'mir2-assets\original-effects\effects.generated.json', 'mir2-assets\crystal-map-pack\0.map.gz', 'mir2-assets\original-ui\frame-sets.generated.json', 'mir2-assets\original-ui\Prguse\20.png', 'mir2-assets\original-ui\Sound\Login2.wav', 'mir2-assets\original-ui\Sound\Select2.wav', 'mir2-assets\original-ui\Sound\M8-1.wav', 'mir2-assets\original-ui\Sound\M31-0.wav', 'mir2-assets\original-ui\Sound\M31-1.wav', 'mir2-assets\original-ui\Sound\M31-2.wav', 'mir2-assets\original-ui\Sound\M34-0.wav', 'mir2-assets\original-ui\Sound\M34-1.wav', 'mir2-assets\original-ui\Sound\M34-2.wav', 'mir2-assets\original-ui\Sound\M39-0.wav', 'mir2-assets\original-ui\Sound\M39-1.wav', 'mir2-assets\original-ui\Sound\M40-0.wav', 'mir2-assets\original-ui\Sound\M64-0.wav', 'mir2-assets\original-ui\Sound\M64-1.wav', 'mir2-assets\original-ui\Sound\M64-2.wav', 'mir2-assets\original-ui\Sound\M79-1.wav')
    ...
    foreach($index in @(411,567,633,634,635,636,637,638,820,821,822,823,824,827,848,850,851,853)){ $required += "mir2-assets\original-ui\Title\$index.png" }
    foreach($index in @(1,1903,1904,1905,1970,1973,1976,1979,1982,1985,1988,1991,1992,1993,1994,1995,1996,2000,2090,2096,2097,2098)){ $required += "mir2-assets\original-ui\Prguse\$index.png" }
...
if ($SelfTest) {
    ...
    try {
        ...
        $unicodeNoBreakSpace=[string][char]0x00A0;$unicodeFullwidthFullStop=[string][char]0xFF0E;$allowedLayoutVectors=@('mir2-platform-windows.exe','mir2-client.toml','README-START.txt','CONTROLS.txt','KNOWN-ISSUES.md','BUILD-ATTESTATION.json','PACKAGE-MANIFEST.json','VERSION.json','RELEASE-STATEMENT.json','RELEASE-STATEMENT.p7s','mir2-assets/bevy-entity-atlases/manifest.json','mir2-assets/generated/map-atlas/0.png','mir2-assets/generated/native-map-keyed/manifest.json','mir2-assets/crystal-map-pack/0.map.gz','mir2-assets/original-effects/effects.generated.json','mir2-assets/original-effects/sprite.v1.final.PNG',('mir2-assets/original-effects/folder'+$unicodeNoBreakSpace+'/0.png'),('mir2-assets/original-effects/payload'+$unicodeFullwidthFullStop+'exe.png'),'mir2-assets/original-ui/frame-sets.generated.json','mir2-assets/original-ui/ChrSel/0.png','mir2-assets/original-ui/Sound/Login2.wav','mir2-assets/original-ui/Sound/Select2.wav','mir2-assets/original-ui/Sound/M8-1.wav','mir2-assets/original-ui/Sound/M31-0.wav','mir2-assets/original-ui/Sound/M31-1.wav','mir2-assets/original-ui/Sound/M31-2.wav','mir2-assets/original-ui/Sound/M34-0.wav','mir2-assets/original-ui/Sound/M34-1.wav','mir2-assets/original-ui/Sound/M34-2.wav','mir2-assets/original-ui/Sound/M39-0.wav','mir2-assets/original-ui/Sound/M39-1.wav','mir2-assets/original-ui/Sound/M40-0.wav','mir2-assets/original-ui/Sound/M64-0.wav','mir2-assets/original-ui/Sound/M64-1.wav','mir2-assets/original-ui/Sound/M64-2.wav','mir2-assets/original-ui/Sound/M79-1.wav');foreach($soundName in $PlayerCombatSoundNames){$allowedLayoutVectors+='mir2-assets/original-ui/Sound/'+$soundName};foreach($rel in $allowedLayoutVectors){if(-not(Test-PackageRelativeFileAllowed -RelativePath $rel -ExeName 'mir2-platform-windows.exe')){throw "strict allowlist rejected valid path: $rel"}}
        ...
        [IO.File]::WriteAllBytes((Join-Path $requiredProbe 'mir2-assets\original-ui\frame-sets.generated.json'), [byte[]](1)); Remove-Item -LiteralPath (Join-Path $requiredProbe 'mir2-assets\original-ui\Title\823.png') -Force; $missingRequired = @(Get-MissingRequiredCandidateFiles -PackageRoot $requiredProbe -ExeName 'mir2-platform-windows.exe'); if ($missingRequired.Count -ne 1 -or $missingRequired[0] -cne 'mir2-assets\original-ui\Title\823.png') { throw 'required-file self-test did not fail closed for missing VIS-03 disabled Teleport asset' }
        ...
        [IO.File]::WriteAllBytes((Join-Path $requiredProbe 'mir2-assets\original-effects\Magic\1635.png'), [byte[]](1)); Remove-Item -LiteralPath (Join-Path $requiredProbe 'mir2-assets\original-ui\Sound\M8-1.wav') -Force; $missingRequired = @(Get-MissingRequiredCandidateFiles -PackageRoot $requiredProbe -ExeName 'mir2-platform-windows.exe'); if ($missingRequired.Count -ne 1 -or $missingRequired[0] -cne 'mir2-assets\original-ui\Sound\M8-1.wav') { throw 'required-file self-test did not fail closed for missing VIS-02 FlamingSword attack sound' }
...
foreach ($identity in $gameplaySoundIdentities) { $soundPath = Join-Path $PackageRoot ('mir2-assets\original-ui\Sound\' + $identity.name); if (Test-Path -LiteralPath $soundPath -PathType Leaf) { $soundItem = Get-Item -LiteralPath $soundPath; if ([int64]$soundItem.Length -ne $identity.size -or (Get-FileHash -LiteralPath $soundPath -Algorithm SHA256).Hash.ToUpperInvariant() -cne $identity.sha256) { Fail "$($identity.name) identity mismatch" } } }
try {
