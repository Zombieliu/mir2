...
function Get-RequiredCandidateFiles {
    ...
    $required = @($ExeName, 'BUILD-ATTESTATION.json', 'PACKAGE-MANIFEST.json', 'VERSION.json', 'RELEASE-STATEMENT.json', 'RELEASE-STATEMENT.p7s', 'mir2-client.toml', 'README-START.txt', 'CONTROLS.txt', 'KNOWN-ISSUES.md', 'mir2-assets\bevy-entity-atlases\manifest.json', 'mir2-assets\generated\map-atlas\manifest.json', 'mir2-assets\generated\native-map-keyed\manifest.json', 'mir2-assets\original-effects\effects.generated.json', 'mir2-assets\crystal-map-pack\0.map.gz', 'mir2-assets\original-ui\frame-sets.generated.json', 'mir2-assets\original-ui\Prguse\20.png', 'mir2-assets\original-ui\Sound\Login2.wav', 'mir2-assets\original-ui\Sound\Select2.wav', 'mir2-assets\original-ui\Sound\M8-1.wav', 'mir2-assets\original-ui\Sound\M31-0.wav', 'mir2-assets\original-ui\Sound\M31-1.wav', 'mir2-assets\original-ui\Sound\M31-2.wav', 'mir2-assets\original-ui\Sound\M39-0.wav', 'mir2-assets\original-ui\Sound\M39-1.wav', 'mir2-assets\original-ui\Sound\M40-0.wav', 'mir2-assets\original-ui\Sound\M64-0.wav', 'mir2-assets\original-ui\Sound\M64-1.wav', 'mir2-assets\original-ui\Sound\M64-2.wav', 'mir2-assets\original-ui\Sound\M79-1.wav')
...
if ($SelfTest) {
    ...
    try {
        ...
        [IO.File]::WriteAllBytes((Join-Path $requiredProbe 'mir2-assets\original-effects\Magic\165.png'), [byte[]](1)); Remove-Item -LiteralPath (Join-Path $requiredProbe 'mir2-assets\original-ui\Sound\M64-2.wav') -Force; $missingRequired = @(Get-MissingRequiredCandidateFiles -PackageRoot $requiredProbe -ExeName 'mir2-platform-windows.exe'); if ($missingRequired.Count -ne 1 -or $missingRequired[0] -cne 'mir2-assets\original-ui\Sound\M64-2.wav') { throw 'required-file self-test did not fail closed for missing VIS-02 SoulFireBall impact sound' }
