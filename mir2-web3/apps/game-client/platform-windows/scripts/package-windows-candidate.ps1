...
if ($SelfTest) {
    ...
    try {
        ...
        $allowedLayoutVectors += @('mir2-assets/original-ui/Sound/M41-1.wav','mir2-assets/original-ui/Sound/M41-2.wav','mir2-assets/original-ui/Sound/M76-0.wav')
...
try {
 ...
 foreach ($soundName in $hallucinationSoundNames) { $requiredSources += (Join-Path $PublicRoot ('original-ui\Sound\' + $soundName)) }
