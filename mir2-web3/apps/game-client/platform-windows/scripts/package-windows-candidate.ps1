...
foreach ($soundName in @('Login2.wav','Select2.wav','M8-1.wav','M31-0.wav','M31-1.wav','M31-2.wav','M39-0.wav','M39-1.wav','M40-0.wav','M64-0.wav','M64-1.wav','M64-2.wav','M79-1.wav') + $playerCombatSoundNames) { $sound = Join-Path $PublicRoot ('original-ui\Sound\' + $soundName); Assert-NoReparseTree -Path $sound; Assert-NoAlternateDataStreams -Path $sound }
...
try {
    ...
    foreach ($sound in @('Login2.wav', 'Select2.wav', 'M8-1.wav', 'M31-0.wav', 'M31-1.wav', 'M31-2.wav', 'M39-0.wav', 'M39-1.wav', 'M40-0.wav', 'M64-0.wav', 'M64-1.wav', 'M64-2.wav', 'M79-1.wav') + $playerCombatSoundNames) { Copy-FileDefaultDataOnly -Source (Join-Path $PublicRoot ('original-ui\Sound\' + $sound)) -Destination (Join-Path $soundDest $sound) }
