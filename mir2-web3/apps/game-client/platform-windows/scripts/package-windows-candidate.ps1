...
function Test-PackageRelativeFileAllowed {
    ...
    if (@('mir2-assets/original-ui/Sound/Login2.wav','mir2-assets/original-ui/Sound/Select2.wav','mir2-assets/original-ui/Sound/M31-0.wav','mir2-assets/original-ui/Sound/M31-1.wav','mir2-assets/original-ui/Sound/M31-2.wav','mir2-assets/original-ui/Sound/M40-0.wav','mir2-assets/original-ui/Sound/M64-0.wav','mir2-assets/original-ui/Sound/M64-1.wav','mir2-assets/original-ui/Sound/M64-2.wav') -ccontains $RelativePath) { return $true }
...
if ($SelfTest) {
    ...
    try {
        ...
        $allowedLayoutVectors = @('mir2-platform-windows.exe','mir2-client.toml','README-START.txt','CONTROLS.txt','KNOWN-ISSUES.md','BUILD-ATTESTATION.json','PACKAGE-MANIFEST.json','VERSION.json','RELEASE-STATEMENT.json','RELEASE-STATEMENT.p7s','mir2-assets/bevy-entity-atlases/manifest.json','mir2-assets/generated/map-atlas/0.png','mir2-assets/generated/native-map-keyed/manifest.json','mir2-assets/crystal-map-pack/0.map.gz','mir2-assets/original-effects/effects.generated.json','mir2-assets/original-effects/sprite.v1.final.PNG',('mir2-assets/original-effects/folder'+$unicodeNoBreakSpace+'/0.png'),('mir2-assets/original-effects/payload'+$unicodeFullwidthFullStop+'exe.png'),'mir2-assets/original-ui/frame-sets.generated.json','mir2-assets/original-ui/ChrSel/0.png','mir2-assets/original-ui/Sound/Login2.wav','mir2-assets/original-ui/Sound/Select2.wav','mir2-assets/original-ui/Sound/M31-0.wav','mir2-assets/original-ui/Sound/M31-1.wav','mir2-assets/original-ui/Sound/M31-2.wav','mir2-assets/original-ui/Sound/M40-0.wav','mir2-assets/original-ui/Sound/M64-0.wav','mir2-assets/original-ui/Sound/M64-1.wav','mir2-assets/original-ui/Sound/M64-2.wav')
...
try {
 ...
 $requiredSources = @((Join-Path $PublicRoot 'bevy-entity-atlases\manifest.json'), (Join-Path $PublicRoot 'generated\map-atlas\manifest.json'), (Join-Path $nativeKeyedMapRoot 'manifest.json'), (Join-Path $PublicRoot 'original-effects\effects.generated.json'), (Join-Path $MapPackRoot '0.map.gz'), (Join-Path $PublicRoot 'original-ui\frame-sets.generated.json'), (Join-Path $PublicRoot 'original-ui\ChrSel\0.png'), (Join-Path $PublicRoot 'original-ui\MMap\101.png'), (Join-Path $PublicRoot 'original-ui\Prguse\20.png'), (Join-Path $PublicRoot 'original-ui\Prguse\1084.png'), (Join-Path $PublicRoot 'original-ui\UI_32bit\472.png'), (Join-Path $PublicRoot 'original-ui\Title\30.png'), (Join-Path $PublicRoot 'original-ui\Title\411.png'), (Join-Path $PublicRoot 'original-ui\AArmour\00\0.png'), (Join-Path $PublicRoot 'original-ui\Monster\000\0.png'), (Join-Path $PublicRoot 'original-ui\NPC\00\0.png'), (Join-Path $PublicRoot 'original-ui\Sound\Login2.wav'), (Join-Path $PublicRoot 'original-ui\Sound\Select2.wav'), (Join-Path $PublicRoot 'original-ui\Sound\M31-0.wav'), (Join-Path $PublicRoot 'original-ui\Sound\M31-1.wav'), (Join-Path $PublicRoot 'original-ui\Sound\M31-2.wav'), (Join-Path $PublicRoot 'original-ui\Sound\M40-0.wav'), (Join-Path $PublicRoot 'original-ui\Sound\M64-0.wav'), (Join-Path $PublicRoot 'original-ui\Sound\M64-1.wav'), (Join-Path $PublicRoot 'original-ui\Sound\M64-2.wav'))
...
foreach ($sound in @((Join-Path $PublicRoot 'original-ui\Sound\Login2.wav'), (Join-Path $PublicRoot 'original-ui\Sound\Select2.wav'), (Join-Path $PublicRoot 'original-ui\Sound\M31-0.wav'), (Join-Path $PublicRoot 'original-ui\Sound\M31-1.wav'), (Join-Path $PublicRoot 'original-ui\Sound\M31-2.wav'), (Join-Path $PublicRoot 'original-ui\Sound\M40-0.wav'), (Join-Path $PublicRoot 'original-ui\Sound\M64-0.wav'), (Join-Path $PublicRoot 'original-ui\Sound\M64-1.wav'), (Join-Path $PublicRoot 'original-ui\Sound\M64-2.wav'))) { Assert-NoReparseTree -Path $sound; Assert-NoAlternateDataStreams -Path $sound }
...
try {
    ...
    foreach ($sound in @('Login2.wav', 'Select2.wav', 'M31-0.wav', 'M31-1.wav', 'M31-2.wav', 'M40-0.wav', 'M64-0.wav', 'M64-1.wav', 'M64-2.wav')) { Copy-FileDefaultDataOnly -Source (Join-Path $PublicRoot ('original-ui\Sound\' + $sound)) -Destination (Join-Path $soundDest $sound) }
