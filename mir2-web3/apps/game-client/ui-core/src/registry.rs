...
pub fn all_controls() -> Vec<ControlEntry> {
    let mut controls = vec![
        ...
        c!("MENU.MENTOR", "InGame", "System Menu", "MentorButton", "Mentor", "button", rect(3.0,202.0,32.0,20.0), "single", 1, "InGame", "ToggleMentor", "Original Mentor page and authoritative invitations", "CloseWindows", "implemented_pending_functional_and_visual", OVERLAY, None, false),
        c!("MENU.RELATIONSHIP", "InGame", "System Menu", "RelationshipButton", "Relationship", "button", rect(3.0,221.0,32.0,20.0), "single", 1, "InGame", "ToggleRelationship", "Original relationship page and ordinary social requests", "CloseWindows", "implemented_pending_functional_and_visual", OVERLAY, None, false),
        c!("MENU.KEYBOARD", "InGame", "System Menu", "KeyboardButton", "Keyboard", "button", rect(3.0,69.0,32.0,20.0), "single", 1, "InGame", "ToggleKeyboard", "Crystal binding editor and persisted supported shortcuts; remaining action integrations tracked as gaps", "CloseWindows", "implemented_pending_functional_and_visual", OVERLAY, None, false),
        c!("MENU.MOUNT", "InGame", "System Menu", "MountButton", "Mount", "button", rect(3.0,145.0,32.0,20.0), "single", 1, "InGame", "ToggleMount", "Original mount slots, animation, loyalty, ride and equipped attachment operations", "CloseWindows", "implemented_pending_visual", OVERLAY, None, false),
        c!("MENU.FISHING", "InGame", "System Menu", "FishingButton", "Fishing", "button", rect(3.0,164.0,32.0,20.0), "single", 1, "InGame", "ToggleFishing", "Original rod slots and authoritative fishing status and map cast", "CloseWindows", "implemented_pending_visual", OVERLAY, None, false),
        c!("MENU.CREATURE", "InGame", "System Menu", "CreatureButton", "Creature", "button", rect(3.0,126.0,32.0,20.0), "single", 1, "InGame", "ToggleCreature", "Original creature list, summon, modes, filter, rename and verified release", "CloseWindows", "implemented_pending_visual", OVERLAY, None, false),
        c!("MENU.FRIENDS", "InGame", "System Menu", "FriendButton", "Friends", "button", rect(3.0,183.0,32.0,20.0), "single", 1, "InGame", "ToggleFriends", "Original friend tabs and stable identity requests", "CloseWindows", "implemented_pending_visual", OVERLAY, None, false),
        c!("MENU.RANKING", "InGame", "System Menu", "RankingButton", "Ranking", "button", rect(3.0,88.0,32.0,20.0), "single", 1, "InGame", "ToggleRanking", "Original ranking filters, pagination, authoritative rows and player equipment inspection", "CloseWindows", "implemented_pending_visual", OVERLAY, None, false),
