      ...
      if (state.stage !== 'readyToTurnIn') {
        ...
        if (q.objectives.kill.length || q.objectives.item.length) {
          ...
          record.objectives = await completeQuestObjectives(client, q, navigate, {
            ...
            maxTargetAdjacent: id === 30 ? 2 : (id === 42 ? 1 : (id === 49 ? 1 : (id === 54 ? 1 :
              (id === 33 && className === 'Wizard' ? 1 : 0)))),
            maxTargetNearby: id === 30 ? 4 : (id === 42 ? 3 : (id === 49 ? 4 : (id === 54 ? 4 :
            ...
            finishableTargetHealthRatio: id === 33 && className === 'Taoist' ? 0.25 : undefined,
            finishableTargetMinimumPlayerHpRatio: id === 33 && className === 'Taoist' ? 0.4 : undefined,
