...
const definitions = [
  ...
  ['mines','Mines and rescue',16,20,21,[51,52,53,54,60,61,62,65],8,'Prepare supplies, clear the mines, and help the woodland expedition.','Belt and necklace choices plus a level-20 class weapon.'],
  ['expedition','Lead an expedition',21,25,26,[83,86,87,88,89,97,98,99,102,103,110,111,112],10,'Investigate the missing carriage, scout Wooma, and uncover the secret path.','The secret path plus level-25 class armour and a level-26 weapon.'],
