...
// output file tracing keeps each serverless function under Vercel's 300MB limit
...
// subtrees. JSON/meta under public/ is intentionally NOT excluded because
// /api/original-ui-meta reads it at runtime.
