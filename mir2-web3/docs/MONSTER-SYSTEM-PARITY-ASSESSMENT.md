...
20. **Profile-missed on-hit poisons** — three data-only families carry a `PoisonTarget` the profile extractor skipped (it lives in `CompleteRangeAttack` or a non-standard branch): **LightTurtle** (74) green, **HellCannibal** (78) red, **FlameAssassin** (95) slow. Restored 1:1. (Three Dazed families — HellSlasher 76, TrollKing 91, StoningStatue 135 — await a chance-gated Dazed status variant; CharmedSnake 63 is a charmed pet, not a hostile.)
