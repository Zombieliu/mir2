...
- Product evolution note: future work is expected to turn this verified Mir2-style MMORPG foundation into a custom product. Read `docs/POST-1TO1-EVOLUTION-PLAN.md` before database, cache, login UI, or NPC script parser changes. Preserve the current Candidate baseline as a regression reference, but do not treat intentional product divergence as a Crystal parity bug.
