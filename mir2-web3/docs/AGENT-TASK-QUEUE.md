...
Product evolution handoff: after the 1:1 Candidate baseline, future product work should also read `docs/POST-1TO1-EVOLUTION-PLAN.md` and `docs/TECH-MODERNIZATION-RFC.md`. Database, cache, login UI, admin backend, global zone, and NPC script parser changes are expected product-evolution areas, not automatic Crystal parity regressions.
