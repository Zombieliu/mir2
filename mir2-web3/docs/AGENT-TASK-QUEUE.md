...
| [~] | Full seal-source validation | Already-sealed rejection, source item validation, reseal-delay metadata, save/reload, and legacy defaults are in. Exact seal item rules and formal client combine flow remain. |
