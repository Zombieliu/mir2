...
Backend/server parity estimate: **77.16%**. This is not the whole-project score; it only covers Rust backend, gateway, protocol, persistence, and server gameplay behavior.
...
| **Total** | **100%** |  | **61.7%** | Whole-project estimate, not interchangeable with the backend 77.16% tracker. |
