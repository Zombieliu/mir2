...
## Mail body package (prepared, not deployed)

Source3b8bd01f9, package C:/numeron-legend-of-rebirth-20260922-mail-body. Both release builds pass: mail-body-client-build.log and mail-body-gateway-build.log. Client SHA256FFF2D45DEC2DC542BA22CF410B7E195B74AB9EDA9712CCAFA7CD888C9B365607; Gateway SHA256ADC7B40FB6E3734D6C57E3C069625F72EC464E4C8C71DFB316CBBDB2406CD651. This includes the preceding integrated map/hierarchy/postage fixes plus UTF-16 body validation. Config and shared asset junction are retained. Read-only process inspection confirms the user's parcel-map client54284 and Gateway55572 are still running. No process replacement, account edit, real mail delivery or desktop input occurred. Unlike the earlier client-only geometry candidate, deploying this paired package requires normal logout and Gateway replacement to activate backend length validation. Pending takeover handoff remains unanswered.

Prepared wheel package (not launched): C:/numeron-legend-of-rebirth-20260922-mail-wheel, source159cfc832. Windows release build passes in mail-wheel-client-build.log. Client SHA25656AAEDC17B226EC4251F2A1269EF7673757E5EB1AF99B4C0D9F2B7B51D72A90D; Gateway remains the paired500 UTF-16 build ADC7B40FB6E3734D6C57E3C069625F72EC464E4C8C71DFB316CBBDB2406CD651. This binds the1025-test wheel/chat candidate; subsequent stamp-state or attachment-lock edits are not included. No desktop input, deployment or visual pass occurred.

Read-only live-state check at2026-09-22 02:55 +08:00: parcel-map client PID54284 no longer exists and no replacement mir2-platform-windows process is present. Gateway55572 remains responsive; no established19900/19910 connection was found. Client stderr ends02:25:35; Gateway stderr updated02:26:01 records remote connection reset, successful immutable teardown checkpoint save, and15-second reconnect grace. There is no LogOutSuccess or explicit panic/OOM in this client's log tail, and the last4h Application1000/1001 query returned no matching client event. Exit cause is undetermined, not a proven clean logout or a stability pass. No client relaunch/service replacement or desktop activation was performed; takeover handoff remains pending.

Latest prepared candidate (not deployed): C:/numeron-legend-of-rebirth-20260922-mail-lock. Client source4d6f973ac; release build passes (mail-lock-client-build.log); client SHA256279E0FC038DEE6BA7D475A023BB6FB87E8E5B4DFA727883052F3A3C4DE497B56. Gateway remains3b8bd01f9 / ADC7B40FB6E3734D6C57E3C069625F72EC464E4C8C71DFB316CBBDB2406CD651. Package candidate-manifest.json records both source versions, executable/config hashes, shared non-immutable asset junction and false deployment/visual-acceptance flags. Includes attachment input locks and stamp state plus all preceding fixes. Clipboard/IME work began only after this build completed and is not part of this executable. No client was started or service replaced.

NPC sale count source correction: MirItemCell.cs:2597-2630 shows counts only for stackable items, in yellow at the item cell bottom-right, without an x prefix. NPCDrop now follows that rule with the selected sale amount and original default font, preserving unstackable/no-label behavior and no additional quantity picker. Included in client UI1035/1035 (mail-text-client-full.log); source/render-code correction, not a desktop visual pass.
