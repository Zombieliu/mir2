...
Goal scope is unchanged. The live manual-acceptance package remains C:/numeron-legend-of-rebirth-20260922-parcel-map (client E088C0ED52EC23C0BE93F2CEFC314174E3D5FE703FBAD1A7CD9455E06EF52E5C). Latest prepared paired package: C:/numeron-legend-of-rebirth-20260922-mail-body, source3b8bd01f9; exact client/Gateway hashes and build logs are in README.md. It includes source-size map geometry, fallback hierarchy, postage reserves and500 UTF-16 body validation. It is not launched and requires normal-exit handoff. Startup/LoginSuccess alone is not page acceptance. Test counts are code evidence, not a page-acceptance denominator. Historical partial screenshots belong to their explicitly recorded older packages.
