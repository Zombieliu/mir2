...
| WN-ITEM-002 | P0 | Item icons | Every carried/belt/equipment item in the audited slice renders its exact source icon, count, durability overlays, and unavailable state. | The full 1628-row/924-image asset gate remains intact. Current-count UserItem.Image, valid source Items/0, alpha-bound full-bitmap placement and StackSize-driven count 1 now cover primary bag/belt/equipment/storage/NPC and retained Guild paths; warehouse-side/trade/amount icon regions share the helper. Native UI 562/562 and Windows 528/528 pass, with all 1003 exported PNGs source-verified and 5015 node geometries checked. Legacy zero without source stays absent. Historical stack/MirArmour captures retain their original binary limits; no final-source GUI capture exists. Full trade/other windows, source operations/state overlays, FloorItems, real input and human gates remain open. | Retain all 924 required images and the full 1003-export fixture; finish concrete-item windows and source operations/overlays without changing valid base-image previews. After user resumes foreground QA, capture final-source count/equip/store/trade transitions and trusted original-pair/DPI/human comparisons. |
| WN-ITEM-003 | P1 | Item detail tooltip | Hover shows source-correct name, type, weight, durability, stats, requirements, bind/trade restrictions, description, price, and comparison where Crystal does. | Personal-item source sections, recursive instance/socket metadata, clamping and disabled-cell hints retain existing automated and historical WoodenSword evidence. NPC MirGoodsCell/HideAddedStats keeps its populated historical capture; the new shared alpha-size helper now corrects NPC/primary centring with actual-PNG regressions. Guild has source grid/scroll and common hints. No new populated final-source GUI captures exist. GameShop, quest rewards and trade still need exact full layouts/captures; duplicate/sub-goods topology, complete operations/overlays, soul-bound names and Hero requirement 129 remain open. | Retain the corrected primary/NPC image and hint regressions; finish specialized geometry/topology and item-operation matrices, then populated final-source captures, full text/overlap behavior, trusted package/light, real 100/125/150% DPI and human same-state Crystal comparison. |
