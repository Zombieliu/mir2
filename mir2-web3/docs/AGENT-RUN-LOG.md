...
> Previous truth-audit sync: 2026-04-27. Added `docs/PARITY-TRUTH-AUDIT.md` and linked it from the handoff/queue/roadmap/Windows docs. At that time the authoritative wording was automated parity evidence **100% Candidate**, backend/server tracked slice **99.70% Candidate**, and whole-project accepted Crystal 1:1 **roughly 90%**. R300 supersedes the backend tracked-slice packet wording under explicit stable-diff acceptance; human visual/feel acceptance remains the whole-project Accepted gate.
