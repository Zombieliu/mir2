...
> 新开发者请从本页开始。跨平台交付架构见 [`docs/DEVELOPER-DELIVERY.md`](mir2-web3/docs/DEVELOPER-DELIVERY.md)，
> macOS 说明见 [`docs/LOCAL-DEVELOPMENT-MACOS.md`](mir2-web3/docs/LOCAL-DEVELOPMENT-MACOS.md)，
> Windows 说明见 [`docs/LOCAL-DEVELOPMENT-WINDOWS.md`](mir2-web3/docs/LOCAL-DEVELOPMENT-WINDOWS.md)。
> 授权前必须阅读 [`docs/LEGAL-AND-ASSET-RIGHTS.md`](mir2-web3/docs/LEGAL-AND-ASSET-RIGHTS.md)。
...
全量素材不会提交进 Git。Starter、私有包和 R2 的详细边界见 [`docs/ASSET-CONSUMER-SETUP.md`](mir2-web3/docs/ASSET-CONSUMER-SETUP.md)。
...
这个私有包是完整的**转换后视觉图集**，不是原生客户端备份，也不包含完整 Crystal 声音库。Git 只携带 4 个 Starter WAV；需要全量音频时，必须由项目所有者另行提供合法授权的数据源或未来经过验收的私有/CDN 音频发布，具体边界见 [`docs/ASSET-CONSUMER-SETUP.md`](mir2-web3/docs/ASSET-CONSUMER-SETUP.md)。
...
开始修改前请阅读 [`CONTRIBUTING.md`](CONTRIBUTING.md) 和 [`docs/AGENT-ORCHESTRATION.md`](mir2-web3/docs/AGENT-ORCHESTRATION.md)。不要提交账号库、`.env.local`、R2 凭据、Crystal 原始客户端文件或 `generated/crystal-packs/full`。
